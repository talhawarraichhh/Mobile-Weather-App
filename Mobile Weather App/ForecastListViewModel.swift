        ...
        if location == "" {
            ...
            CLGeocoder().geocodeAddressString(location) { (placemarks, error) in
                ...
                if let lat = placemarks?.first?.location?.coordinate.latitude,
                  ...
                  apiService.getJSON(urlString:"https://api.openweathermap.org/data/3.0/onecall?lat=\(lat)&lon=\(lon)&exclude=current,minutely,hourly,alerts&appid=2a60797e8bda3a3f0a6b530d8286da6c",
...
// 2a60797e8bda3a3f0a6b530d8286da6c
